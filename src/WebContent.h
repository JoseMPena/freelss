...
public:
	...
	static const std::string ARDUINO_SERIAL_PATH;
	static const std::string ARDUINO_BAUD_RATE;
	static const std::string FEED_RATE;
...
private:
	...
	static const std::string ARDUINO_SERIAL_PATH_DESCR;
	static const std::string ARDUINO_BAUD_RATE_DESCR;
	static const std::string FEED_RATE_DESCR;
